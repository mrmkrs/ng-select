...
var SelectDropdownComponent = (function () {
    ...
    SelectDropdownComponent.prototype.hasChildren = function (option) {
        return option.hasChildren();
    };
    SelectDropdownComponent.prototype.getChildren = function (option) {
        return option.children.options;
    };
    SelectDropdownComponent.prototype.getFilteredChildren = function (option) {
